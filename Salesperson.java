...
public class Salesperson {
    ...
    public static String dbAddress = "jdbc:mysql://localhost:3306/project?autoReconnect=true&useSSL=false";
    public static String dbUsername = "root";
    public static String dbPassword = "Andy+=690514";
    ...
    public static void search() {
        ...
        try {
            ...
            int search3 = scan3.nextInt();
                ...
                String psql = """
                        SELECT P.pid, P.pname, M.mname, C.cname, P.pavailablequantity, P.pwarrentyperiod, P.pprice
        ...
        try {
            ...
            if(r != null) {
                ...
                if(t == null){
                    ...
                    System.out.println("The part is unavaible! Please choose another part.");
                }else if( t > 0 ) {
